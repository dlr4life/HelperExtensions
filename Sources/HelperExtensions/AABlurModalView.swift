...
open class AABlurModalView: UIView {
    ...
    static func hideBlurModalView(_ identifier: String?) {
    ...
    fileprivate func setupContentView() {
        ...
        let viewDict : [String: Any] = ["cV":contentView as Any, "view":self]
        ...
        [NSLayoutConstraint.constraints(withVisualFormat: "V:[cV(cVHeight)]", options: [], metrics: metrics, views: viewDict),
            ...
            NSLayoutConstraint.constraints(withVisualFormat: "H:[view]-(<=1)-[cV]", options: NSLayoutConstraint.FormatOptions.alignAllCenterY, metrics: nil, views: viewDict),
            NSLayoutConstraint.constraints(withVisualFormat: "V:[view]-(<=1)-[cV]", options: NSLayoutConstraint.FormatOptions.alignAllCenterX, metrics: nil, views: viewDict)
            ].forEach { NSLayoutConstraint.activate($0) }
    }

    fileprivate func snapshot() -> UIImage? {
        let appDelegate = UIApplication.shared.delegate
        guard (appDelegate?.window) != nil else { return nil }
...
public extension UIView {
    ...
    func hideBlurModalView(_ identifier: String? = nil) {
        if identifier != nil {
